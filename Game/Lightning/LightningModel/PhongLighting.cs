...
//            return new Color(ApplyAmbientLightning(triangle, lightSource).rgb.Normalize());
            return new Color(ApplyDiffuseLightning(triangle, fragPosition, triangleNormal, lightSource).rgb.Normalize());
